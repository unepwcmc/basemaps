...
@serif: "Open Sans Regular", @fallback;
@serif_md: "Open Sans Semibold", @fallback;
@serif_bd: "Open Sans Bold", @fallback;
@serif_it: "Open Sans Semibold Italic", @fallback;
//sans
@sans:  "Open Sans Regular", @fallback;
@sans_md: "Open Sans Semibold", @fallback;
@sans_bd:  "Open Sans Bold", @fallback;
@sans_bk:  "Open Sans Semibold", @fallback;
@sans_it: "Open Sans Semibold Italic", @fallback;
@sans_it_md: "Open Sans Semibold Italic", @fallback;
@sans_it_bd: "Open Sans Bold Italic", @fallback;
